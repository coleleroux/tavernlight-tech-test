...
function online()
  spelllistWindow:show() -- show by default
...
function init()
  ...
  spelllistWindow = g_ui.displayUI('jumpframe', modules.game_interface.getRightPanel())
  ...
  spellList = spelllistWindow:getChildById('jumpframe')
